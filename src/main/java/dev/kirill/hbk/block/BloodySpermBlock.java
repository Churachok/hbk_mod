...
public final class BloodySpermBlock extends HalfTransparentBlock {
	public static final MapCodec<BloodySpermBlock> CODEC = simpleCodec(BloodySpermBlock::new);

	public BloodySpermBlock(BlockBehaviour.Properties properties) {
		super(properties);
	}

	@Override
	protected MapCodec<BloodySpermBlock> codec() {
		return CODEC;
	}
